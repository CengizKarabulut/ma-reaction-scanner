            ...
            for side in (1, -1):
                ...
                rows.append({
                    **metadata,
                    ...
                    "bounce_p25_atr": level_metrics.get("bounce_p25_atr", np.nan),
                    "bounce_p75_atr": level_metrics.get("bounce_p75_atr", np.nan),
                    "bounce_mean_atr": level_metrics.get("bounce_mean_atr", np.nan),
                    "reaction_1atr_rate_pct": level_metrics.get("reaction_1atr_rate_pct", np.nan),
                    "reaction_2atr_rate_pct": level_metrics.get("reaction_2atr_rate_pct", np.nan),
                    "median_penetration_atr": level_metrics.get("median_penetration_atr", np.nan),
                    "penetration_p75_atr": level_metrics.get("penetration_p75_atr", np.nan),
                    "penetration_mean_atr": level_metrics.get("penetration_mean_atr", np.nan),
