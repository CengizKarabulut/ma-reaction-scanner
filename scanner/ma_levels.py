    ...
    *,
    ...
    if count == 0:
        return {
            ...
            "bounce_p25_atr": float("nan"),
            "bounce_p75_atr": float("nan"),
            "bounce_mean_atr": float("nan"),
            "reaction_1atr_rate_pct": float("nan"),
            "reaction_2atr_rate_pct": float("nan"),
            "median_penetration_atr": float("nan"),
            "penetration_p75_atr": float("nan"),
            "penetration_mean_atr": float("nan"),
    ...
    return {
        ...
        "bounce_p25_atr": float(np.percentile(bounces, 25)),
        "bounce_p75_atr": float(np.percentile(bounces, 75)),
        "bounce_mean_atr": float(np.mean(bounces)),
        "reaction_1atr_rate_pct": float(100.0 * np.mean(bounces >= 1.0)),
        "reaction_2atr_rate_pct": float(100.0 * np.mean(bounces >= 2.0)),
        "median_penetration_atr": float(np.median(penetrations)),
        "penetration_p75_atr": float(np.percentile(penetrations, 75)),
        "penetration_mean_atr": float(np.mean(penetrations)),
